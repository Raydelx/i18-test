  ...
  return (
    <div>
      <form className='' onSubmit={handleSubmit}>
        ...
        <div className='mb-2'>
        <label htmlFor="activityEmail">E-mailadres</label>
          <input
          id='activityEmail'
            type="email"
            name="activityEmail"
        ...
        <div className='grid md:grid-cols-3 gap-2'>
            <div className='mb-2'>
            <label htmlFor="activityPhone">Telefoonnummer</label>
            <input
              id='activityPhone'
              type="phone"
              name="activityPhone"
          ...
          <div className='mb-2'>
            <label htmlFor="language">Welke taal spreekt u?</label>
              <input
                id='language'
                type="text"
                name="language"
                placeholder="Selecteer uw taal"
                className='w-full px-4 py-3 border-2 placeholder:text-gray-400 rounded-md outline-none focus:ring-4 border-gray-300 focus:border-gray-600 ring-gray-100'
                value={language}
        ...
        <div className='grid md:grid-cols-3 gap-2'>
          <div className='mb-2'>
            <label htmlFor="activityName">Activiteit</label>
          <input
            id='activityName'
            type="text"
            name="activityName"
            
            placeholder="Selecteer uw activiteit"
            className='w-full px-4 py-3 border-2 placeholder:text-gray-400 rounded-md outline-none focus:ring-4 border-gray-300 focus:border-gray-600 ring-gray-100'
            value={activityName}
        ...
        <div className='mb-2'>
        <label htmlFor="activityDate">Datum van deelname aan de activiteit</label>
          <input
          id='activityDate'
            type="date"
            name="activityDate"
        ...
        <div className='mb-2'>
        <label htmlFor="activityNumber">Hoeveel personen?</label>
          <input
          id='activityNumber'
            type="number"
            name="activityTotal"
        ...
        <div className='flex  m-auto align-middle gap-4 pt-7 pb-2'>
          <h2 className='text-3xl  font-semibold'> Deelnemers</h2>
        ...
        {clients.map((client, index) => (
          <div className='flex flex-col md:flex-row gap-2 mb-2' key={index} >
            <div><label htmlFor="name">Naam</label>
            <input
            id='name'
              type="text"
              name="name"
            ...
            />
              ...
              <div>
                <label htmlFor="weight">Gewicht (alleen fietstochten)</label>
                <input
                id='weight'
                  type="number"
                  name="weight"
                  placeholder="Vul uw gewicht in kg in"
                  className='w-full px-4 py-3 border-2 placeholder:text-gray-400 rounded-md outline-none focus:ring-4 border-gray-300 focus:border-gray-600 ring-gray-100'
                  value={client.weight}
                  onChange={(e) => handleChange(index, e)}
              ...
              <div>
              <label htmlFor="height">Lengte (alleen fietstochten)</label>
              <input
                id='height'
                type="number"
                name="height"
                placeholder="Vul uw lengte in meters in"
                className='w-full px-4 py-3 border-2 placeholder:text-gray-400 rounded-md outline-none focus:ring-4 border-gray-300 focus:border-gray-600 ring-gray-100'
                value={client.height}
                onChange={(e) => handleChange(index, e)}
        ...
        <div className="mb-5">
            <label htmlFor="liability" className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <p>Ik accepteer de <button type="button" className="text-blue-500 underline cursor-pointer" onClick={handleModalOpen}> aansprakelijkheidsvoorwaarden</button></p>
        ...
        <button className='bg-[#0E46A3] text-white hover:bg-[#074173]  border-2 border-transparent rounded text-center transition focus-visible:ring-2 ring-offset-2 mt-4 px-6 py-3 ring-gray-200' type="submit">Verzenden</button>
      </form>
